...
Since its original release, 3D-PDR has been used in more than 40 published studies spanning star formation, cosmic-ray physics, and high-redshift galaxy evolution; we highlight a representative selection here. [@Dasyra2022] used 3D-PDR to investigate the heating source for the presence of warm molecular gas in the jets launched by the actively accreting black hole at the center of IC 5063. [@Yang2023] used the code in the chemical analysis of the dense molecular gas in two strongly lensed dusty star-forming galaxies at $z\simeq4$, as part of the SUNRISE broadband spectral line survey. [@Luo2023] applied a similar 3D-PDR-based approach to infer cosmic-ray ioniation rates from molecular observatios of star-forming cores. [@Vermarien2025] built a dedicated dataset of >8000 one-dimensional 3D-PDR models and used it to train and benchmark neural-ODE emulators (NeuralPDR) for fast PDR chemistry prediction. Most recently, [@Roy2026] used 3D-PDR to build a self-consistent chemical model of a dense molecular cloud incorporating cosmic-ray attenuation, testing the reliability of commonly used calibrators for the cosmic-ray ionization rate.
