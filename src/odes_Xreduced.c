...
#include <nvector/nvector_serial.h>             // 用于串行向量实现
#include <sunlinsol/sunlinsol_dense.h>          // 密集矩阵线性求解器
...
#include <sundials/sundials_types_deprecated.h> /* Definition of type realtype */
...
int f(realtype t, N_Vector y, N_Vector ydot, void *user_data)
{
  ...
  zeta_He = 1.0/(487.*(1.0+12.5*pow(x_e,0.994))*(x[25]));
  ...
  form = +rate[296]*x[25]+rate[331]*x[25]*zeta_He;
  ode[1] = form+x[1]*loss;
  ...
  form = +rate[153]*x[18]*x[30]*n_H+rate[169]*x[1]*x[30]*n_H+rate[249]*x[18]*x[31]*n_H+rate[250]*x[18]*x[31]*n_H+rate[266]*x[0]+rate[295]*x[30]+rate[330]*x[30]*zeta_H2;
  ode[5] = form+x[5]*loss;
  ...
  form = +rate[85]*x[1]*x[28]*n_H+rate[90]*x[1]*x[27]*n_H+rate[91]*x[1]*x[4]*n_H+rate[101]*x[4]*x[10]*n_H+rate[161]*x[18]*x[29]*n_H+rate[162]*x[18]*x[29]*n_H+rate[202]*x[14]*x[29]*n_H+rate[298]*x[29]+rate[333]*x[29]*zeta_H;
  ode[7] = form+x[7]*loss;
  ...
  form = +rate[41]*x[26]*x[31]*n_H+rate[77]*x[1]*x[20]*n_H+rate[78]*x[1]*x[16]*n_H+rate[88]*x[1]*x[27]*n_H+rate[89]*x[1]*x[27]*n_H+rate[177]*x[1]*x[24]*n_H+rate[185]*x[14]*x[24]*n_H+rate[186]*x[15]*x[24]*n_H+rate[268]*x[24]+rate[297]*x[24]+rate[300]*x[24]+rate[302]*x[26]+rate[332]*x[24]*zeta_H;
  ...
  form = +rate[49]*x[1]*x[30]*n_H+rate[83]*x[1]*x[11]*n_H+rate[86]*x[1]*x[17]*n_H+rate[94]*x[10]*x[28]*n_H+rate[154]*x[5]*x[31]*n_H+rate[155]*x[1]*x[31]*n_H+rate[156]*x[1]*x[31]*n_H+rate[160]*x[7]*x[31]*n_H+rate[167]*x[14]*x[31]*n_H+rate[265]*x[5]+rate[267]*x[0]+rate[271]*x[26]+rate[285]*x[8]+rate[292]*x[31]+rate[293]*x[30]+rate[329]*x[31]*zeta_H;
  ...
  form = +rate[1]*x[16]*x[31]*n_H+rate[8]*x[24]*x[30]*n_H+rate[15]*x[16]*x[24]*n_H+rate[15]*x[16]*x[24]*n_H+rate[16]*x[24]*x[28]*n_H+rate[24]*x[16]*x[16]*n_H+rate[25]*x[16]*x[29]*n_H+rate[30]*x[16]*x[28]*n_H+rate[122]*x[14]*x[16]*n_H+rate[190]*x[2]*x[26]*n_H+rate[219]*x[23]*x_e*n_H+rate[223]*x[19]*x_e*n_H+rate[224]*x[19]*x_e*n_H+rate[251]*x[24]*x[31]*n_H+rate[273]*x[16]+rate[278]*x[21]+rate[282]*x[11]+rate[304]*x[16]+rate[307]*x[21];
  ...
  form = +rate[3]*x[11]*x[31]*n_H+rate[10]*x[16]*x[30]*n_H+rate[22]*x[11]*x[20]*n_H+rate[24]*x[16]*x[16]*n_H+rate[28]*x[11]*x[16]*n_H+rate[28]*x[11]*x[16]*n_H+rate[29]*x[16]*x[28]*n_H+rate[36]*x[11]*x[29]*n_H+rate[39]*x[11]*x[28]*n_H+rate[83]*x[1]*x[11]*n_H+rate[132]*x[6]*x[11]*n_H+rate[135]*x[6]*x[17]*n_H+rate[136]*x[11]*x[12]*n_H+rate[137]*x[6]*x[27]*n_H+rate[138]*x[11]*x[14]*n_H+rate[198]*x[2]*x[19]*n_H+rate[226]*x[6]*x_e*n_H+rate[229]*x[3]*x_e*n_H+rate[246]*x[19]*x_e*n_H+rate[257]*x[20]*x[30]*n_H+rate[280]*x[11];
  ...
  loss = -rate[0]*x[20]*n_H-rate[1]*x[16]*n_H-rate[2]*x[21]*n_H-rate[3]*x[11]*n_H-rate[4]*x[28]*n_H-rate[5]*x[17]*n_H-rate[6]*x[27]*n_H-rate[7]*x[4]*n_H-rate[41]*x[26]*n_H-rate[43]*x[23]*n_H-rate[44]*x[19]*n_H-rate[46]*x[6]*n_H-rate[47]*x[3]*n_H-rate[154]*x[5]*n_H-rate[155]*x[1]*n_H-rate[156]*x[1]*n_H-rate[160]*x[7]*n_H-rate[167]*x[14]*n_H-rate[249]*x[18]*n_H-rate[250]*x[18]*n_H-rate[251]*x[24]*n_H-rate[252]*x[10]*n_H-rate[253]*x[29]*n_H-rate[254]*x[28]*n_H-rate[292]-rate[315]*x[30]*n_H-rate[316]*x[20]*n_H-rate[317]*x[28]*n_H-rate[318]*x[17]*n_H-rate[319]*x[4]*n_H-2*rate[327]*n_H-rate[329]*zeta_H;
  form = +rate[8]*x[24]*x[30]*n_H+rate[9]*x[20]*x[30]*n_H+rate[10]*x[16]*x[30]*n_H+rate[11]*x[21]*x[30]*n_H+rate[12]*x[29]*x[30]*n_H+rate[13]*x[28]*x[30]*n_H+rate[17]*x[24]*x[28]*n_H+rate[20]*x[20]*x[29]*n_H+rate[21]*x[20]*x[29]*n_H+rate[26]*x[16]*x[29]*n_H+rate[26]*x[16]*x[29]*n_H+rate[37]*x[28]*x[29]*n_H+rate[48]*x[5]*x[30]*n_H+rate[49]*x[1]*x[30]*n_H+rate[50]*x[5]*x[24]*n_H+rate[51]*x[10]*x[30]*n_H+rate[52]*x[5]*x[20]*n_H+rate[53]*x[26]*x[30]*n_H+rate[54]*x[5]*x[16]*n_H+rate[55]*x[23]*x[30]*n_H+rate[56]*x[5]*x[29]*n_H+rate[57]*x[7]*x[30]*n_H+rate[58]*x[5]*x[11]*n_H+rate[59]*x[6]*x[30]*n_H+rate[60]*x[5]*x[11]*n_H+rate[61]*x[5]*x[28]*n_H+rate[62]*x[8]*x[30]*n_H+rate[63]*x[5]*x[17]*n_H+rate[64]*x[12]*x[30]*n_H+rate[65]*x[5]*x[27]*n_H+rate[66]*x[14]*x[30]*n_H+rate[75]*x[0]*x[2]*n_H+rate[77]*x[1]*x[20]*n_H+rate[79]*x[1]*x[16]*n_H+rate[81]*x[1]*x[11]*n_H+rate[84]*x[1]*x[11]*n_H+rate[85]*x[1]*x[28]*n_H+rate[87]*x[1]*x[17]*n_H+rate[93]*x[10]*x[28]*n_H+rate[97]*x[10]*x[17]*n_H+rate[103]*x[26]*x[29]*n_H+rate[104]*x[7]*x[20]*n_H+rate[117]*x[23]*x[29]*n_H+rate[128]*x[7]*x[28]*n_H+rate[129]*x[8]*x[29]*n_H+rate[147]*x[2]*x[3]*n_H+rate[153]*x[18]*x[30]*n_H+rate[157]*x[18]*x[20]*n_H+rate[158]*x[16]*x[18]*n_H+rate[159]*x[18]*x[21]*n_H+rate[161]*x[18]*x[29]*n_H+rate[162]*x[18]*x[29]*n_H+rate[163]*x[11]*x[18]*n_H+rate[164]*x[18]*x[28]*n_H+rate[165]*x[17]*x[18]*n_H+rate[166]*x[2]*x[18]*n_H+rate[168]*x[4]*x[18]*n_H+rate[215]*x[5]*x_e*n_H+rate[215]*x[5]*x_e*n_H+rate[216]*x[0]*x_e*n_H+rate[216]*x[0]*x_e*n_H+rate[216]*x[0]*x_e*n_H+rate[217]*x[0]*x_e*n_H+rate[218]*x[26]*x_e*n_H+rate[219]*x[23]*x_e*n_H+rate[220]*x[23]*x_e*n_H+rate[220]*x[23]*x_e*n_H+rate[222]*x[19]*x_e*n_H+rate[224]*x[19]*x_e*n_H+rate[224]*x[19]*x_e*n_H+rate[225]*x[19]*x_e*n_H+rate[226]*x[6]*x_e*n_H+rate[227]*x[6]*x_e*n_H+rate[227]*x[6]*x_e*n_H+rate[228]*x[8]*x_e*n_H+rate[230]*x[3]*x_e*n_H+rate[231]*x[12]*x_e*n_H+rate[231]*x[12]*x_e*n_H+rate[233]*x[12]*x_e*n_H+rate[234]*x[13]*x_e*n_H+rate[235]*x[13]*x_e*n_H+rate[235]*x[13]*x_e*n_H+rate[237]*x[13]*x_e*n_H+rate[239]*x[22]*x_e*n_H+rate[241]*x[18]*x_e*n_H+rate[265]*x[5]+rate[266]*x[0]+rate[270]*x[20]+rate[273]*x[16]+rate[274]*x[23]+rate[276]*x[21]+rate[277]*x[19]+rate[280]*x[11]+rate[282]*x[11]+rate[284]*x[28]+rate[286]*x[17]+rate[293]*x[30]+rate[294]*x[30]+rate[294]*x[30]+rate[301]*x[20]+rate[302]*x[26]+rate[304]*x[16]+rate[306]*x[21]+rate[309]*x[28]+rate[310]*x[17]+rate[315]*x[30]*x[31]*n_H+rate[315]*x[30]*x[31]*n_H+rate[315]*x[30]*x[31]*n_H+rate[316]*x[20]*x[31]*n_H+rate[316]*x[20]*x[31]*n_H+rate[317]*x[28]*x[31]*n_H+rate[317]*x[28]*x[31]*n_H+rate[318]*x[17]*x[31]*n_H+rate[318]*x[17]*x[31]*n_H+rate[319]*x[4]*x[31]*n_H+rate[320]*x[30]*x_e*n_H+rate[320]*x[30]*x_e*n_H+rate[321]*x[30]*x[30]*n_H+rate[321]*x[30]*x[30]*n_H+rate[322]*x[20]*x[30]*n_H+rate[323]*x[28]*x[30]*n_H+rate[324]*x[17]*x[30]*n_H+rate[328]*x[30]+rate[328]*x[30];
